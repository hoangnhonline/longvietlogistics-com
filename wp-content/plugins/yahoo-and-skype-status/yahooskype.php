			...
			for($i=1;$i<= $this->_number;$i++){
				if(!empty($instance["nick_".$i])){
					if($instance["nick_type_".$i]=='yahoo')
					{
						...
						if($instance['is_show_name_'.$i])
							echo '<li style="text-align:center"><a href="skype:'.$instance["nick_".$i].'?call" title="Talk with me via Skype "><img src="http://mystatus.skype.com/balloon/'.$instance["nick_".$i].'"  alt="Talk with me via Skype" /> <br/>'.$instance["nick_name_".$i].'</a></li>';	
						else
							echo '<li style="text-align:center"><a href="skype:'.$instance["nick_".$i].'?call" title="Talk with me via Skype "><img src="http://mystatus.skype.com/balloon/'.$instance["nick_".$i].'"  alt="Talk with me via Skype" /></a></li>';		
						}
				}	
			}
			echo "</ul>";
